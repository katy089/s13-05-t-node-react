...
const PreferencesColumn = () => {
  ...
  return (
    <div className="font-semibold text-white text-sm items-center flex flex-col gap-3 p-4 w-full h-[89.5vh]">
      ...
      <CustomButton
        className={
          "bg-[#BB7EBC] uppercase rounded-lg flex justify-center p-3 w-4/5"
        }
        text={"gratuita"}
      />
      <p className="mt-8 mb-2 font-bold text-base">Ajustes de descubrimiento</p>
      <div className="bg-[#BB7EBC] flex flex-col justify-between p-4 w-4/5 rounded-xl capitalize">
        <p>Muéstrame</p>
      ...
      <div className="flex flex-grow items-end justify-end w-4/5">
